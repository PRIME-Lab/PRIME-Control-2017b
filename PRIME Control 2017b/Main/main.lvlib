...
<Library LVVersion="16008000">
	...
	<Item Name="feature select.vi" Type="VI" URL="../feature select.vi"/>
	<Item Name="pop vi.vi" Type="VI" URL="../pop vi.vi"/>
	<Item Name="run vis.vi" Type="VI" URL="../run vis.vi"/>
	<Item Name="select vi.vi" Type="VI" URL="../select vi.vi"/>
	<Item Name="stop vis.vi" Type="VI" URL="../stop vis.vi"/>
	<Item Name="upper pop.vi" Type="VI" URL="../upper pop.vi"/>
	<Item Name="upper subpanel selection.ctl" Type="VI" URL="../upper subpanel selection.ctl"/>
</Library>
